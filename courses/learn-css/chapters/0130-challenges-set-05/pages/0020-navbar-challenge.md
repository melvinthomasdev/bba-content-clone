In this challenge, we will be testing
...
- Change the background colour of elements with the class **hero .cta-button** to `#2980B9` when hovered.

**About, Services, Contact Section Styles:**

- Set the text colour of elements with the class **about**, **services**, and **contact** to `#FDFEFE`.
- Set the maximum width of elements with the class **about**, **services**, and **contact** to `800px`.
- Add **auto** margins to elements with the class **about**, **services**, and **contact** for centering horizontally.
- Apply padding of `40px` to elements with the class **about**, **services**, and **contact**.
- Set the background colour of elements with the class **about**, **services**, and **contact** to `#4A8AB7`.
- Apply a box shadow with `0 4px 8px rgba(0, 0, 0, 0.2)` to elements with the class **about**, **services**, and **contact**.
- Add a margin of `20px` from the bottom to elements with the class **about**, **services**, and **contact**.

**Heading Styles for About, Services, Contact Sections:**

- Set the font size of headings within elements with the class **about h2**, **services h2**, and **contact h2** to 24px.
- Add a margin of `20px` from the bottom to headings within elements with the class **about h2**, **services h2**, and **contact h2**.

**Footer Styles:**

- Set the background colour of the footer to `#1B4F72`.
- Set the text colour of the footer to `#FDFEFE`.
- Center the text within the footer.
- Apply padding of `10px` from the top and bottom to the footer.
