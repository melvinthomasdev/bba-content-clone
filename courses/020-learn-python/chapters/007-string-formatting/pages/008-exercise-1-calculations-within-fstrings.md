Given the previous leap year, calculate the next leap year (previous leap year + 4) and print the result in the string **The next leap year is `year`**. Do this calculation within the f-string.
